...
from numpy import array, concatenate, diag, inf, mean, ndarray, newaxis, zeros, int64
...
class CorrelationMiner(AbstractMiner):
    ...
    data_holder: DataHolder
        Object that contains the event log and the names of its necessary
        columns.
    ...
    without case identifiers." International Journal of Cooperative Information
    Systems, 2017
    """
    ...
    def apply(self) -> None:
        ...
        timestamps = {
            i: data[data[act_col] == act][timestamp_col].astype(int64).values / 10 ** 9
        ...
        if solved:
            # Create graph
            graph = create_dfg()
            super()._create_act_nodes(graph, activities)
